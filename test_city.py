...
output_folder = "test_city_output"
...
t1 = time.time()
B.plot_merging_intermediates(imgs_folder=output_folder, show=False)
print("plotted merged buildings intermediates in %.2f seconds" %(time.time() - t1))
